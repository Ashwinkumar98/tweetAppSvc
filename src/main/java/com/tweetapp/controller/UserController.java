...
public class UserController {
	...
	public ResponseEntity<String> registerUser(@RequestBody UserInfoBean userInfo) throws TweetAppException {
	...
	public ResponseEntity<JwtReponseBean> getAuthToken(@RequestBody JwtRequestBean jwtRequestBean) throws Exception {
		...
		return ResponseEntity.ok(new JwtReponseBean(token, expireIn));
